                ...
                <div className="space-y-4 sm:space-y-6">
                  {category.skills.map((skill, skillIndex) => (
                    <div key={skill.name} className="group">
                      ...
                      <div className="w-full bg-secondary-100 dark:bg-gray-600 rounded-full h-2 sm:h-3 overflow-hidden">
                        <motion.div
                          initial={{ width: 0 }}
                          animate={inView ? { width: `${skill.level}%` } : { width: 0 }}
            ...
            >
              <div className="flex items-center space-x-3 mb-4 sm:mb-6">
                <div className="p-2 sm:p-3 bg-green-100 dark:bg-green-900/30 rounded-lg">
                  <FiUser className="text-green-600 dark:text-green-400 text-lg sm:text-xl" />
                </div>
                <h4 className="text-lg sm:text-xl font-bold text-secondary-900 dark:text-white">Soft Skills</h4>
              </div>
              <div className="space-y-3 sm:space-y-4">
                {['Leadership', 'Problem Solving', 'Communication', 'Team Collaboration', 'Project Management', 'Mentoring'].map((skill) => (
                  <div key={skill} className="flex items-center space-x-3 group">
                    <div className="w-2 sm:w-3 h-2 sm:h-3 bg-green-500 rounded-full group-hover:scale-125 transition-transform duration-300"></div>
                    <span className="text-sm sm:text-base text-secondary-700 dark:text-gray-300 font-medium group-hover:text-green-700 dark:group-hover:text-green-400 transition-colors duration-300">{skill}</span>
                  </div>
                ))}
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center space-x-3 mb-4 sm:mb-6">
                <div className="p-2 sm:p-3 bg-blue-100 dark:bg-blue-900/30 rounded-lg">
                  <FiAward className="text-blue-600 dark:text-blue-400 text-lg sm:text-xl" />
                </div>
                <h4 className="text-lg sm:text-xl font-bold text-secondary-900 dark:text-white">Certifications</h4>
              </div>
              <div className="space-y-3 sm:space-y-4">
                {['Microsoft Office Specialist (MOS)', 'Cisco Cybersecurity Essentials', 'Huawei ICT Competition Finalist'].map((cert) => (
                  <div key={cert} className="flex items-center space-x-3 group">
                    <div className="w-2 sm:w-3 h-2 sm:h-3 bg-blue-500 rounded-full group-hover:scale-125 transition-transform duration-300"></div>
                    <span className="text-xs sm:text-sm text-secondary-700 dark:text-gray-300 font-medium group-hover:text-blue-700 dark:group-hover:text-blue-400 transition-colors duration-300">{cert}</span>
                  </div>
                ))}
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center space-x-3 mb-4 sm:mb-6">
                <div className="p-2 sm:p-3 bg-purple-100 dark:bg-purple-900/30 rounded-lg">
                  <FiGlobe className="text-purple-600 dark:text-purple-400 text-lg sm:text-xl" />
                </div>
                <h4 className="text-lg sm:text-xl font-bold text-secondary-900 dark:text-white">Languages</h4>
              </div>
              <div className="space-y-3 sm:space-y-4">
                {['English (Advanced)', 'Kinyarwanda (Native)'].map((lang) => (
                  <div key={lang} className="flex items-center space-x-3 group">
                    <div className="w-2 sm:w-3 h-2 sm:h-3 bg-purple-500 rounded-full group-hover:scale-125 transition-transform duration-300"></div>
                    <span className="text-xs sm:text-sm text-secondary-700 dark:text-gray-300 font-medium group-hover:text-purple-700 dark:group-hover:text-purple-400 transition-colors duration-300">{lang}</span>
                  </div>
                ))}
              </div>
            </motion.div>
