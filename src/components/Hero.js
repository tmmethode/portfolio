      ...
      <div className="container-max text-center relative z-10">
        ...
        >
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            >
              Hi, I'm{' '}
              <span className="gradient-text">Methode TWIZEYIMANA</span>
            </motion.h1>
          ...
          >
            IT professional with experience in cloud infrastructure, systems administration, and cybersecurity. 
            Working with multi-cloud environments (AWS, Google Cloud Platform, Azure, Huawei Cloud), virtualization technologies, and cybersecurity. 
            Developing skills in software development with Python, automation, and DevOps practices.
          </motion.p>
          ...
          >
            {['Cloud Engineer', 'Systems Administrator', 'Cybersecurity Specialist', 'Software Developer'].map((role, index) => (
              <motion.span
                key={role}
